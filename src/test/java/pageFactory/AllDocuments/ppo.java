...
public class ppo {
    ...
    public void clickUploadAndBrowseAndUploadDocument(String documentPath) {
        ...
        wait.until(ExpectedConditions.urlContains("https://uatportal.digiloans.canarabank.in/webdesktop/components/workitem/view/workspace.app"));
       WebElement frameUpload2=driver.findElement(By.xpath("//iframe[@id='ngformIframe']"));
        ...
        wait1.until(ExpectedConditions.urlContains("https://uatportal.digiloans.canarabank.in/webdesktop/components/workitem/view/workspace.app"));
        driver.switchTo().defaultContent();
