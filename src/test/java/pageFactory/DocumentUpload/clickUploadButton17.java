...
public class clickUploadButton17 {
    WebDriver driver;
    public clickUploadButton17(WebDriver driver){
        this.driver=driver;
        PageFactory.initElements(driver,this);
    }
    @FindBy(xpath = "(//a[normalize-space(text())= 'Upload'])[7]")
    WebElement uploadButtonSeven;
    public void clickOnSevenUploadButton() {
