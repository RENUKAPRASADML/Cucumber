...
public class clickUploadButton16 {
    WebDriver driver;
    public clickUploadButton16(WebDriver driver){
        this.driver=driver;
        PageFactory.initElements(driver,this);
    }
    @FindBy(xpath = "(//a[normalize-space(text())= 'Upload'])[6]")
    WebElement uploadButtonSix;
    public void clickOnSixUploadButton() {
